...
let timelineScrubBoost = 0; // temporary speed-up when scrubbing timeline
let lastSliderYear = currentYear;
...
const timeline = [
  {
    ...
    facts: [
      'Global data centers consumed ~200 terawatt-hours of electricity annually—comparable to South Korea’s total usage.',
      'E-waste worldwide hit ~53.6 million metric tons, driven by fast-growing electronics demand.'
    ]
  },
  {
    year: 2021,
    ...
    facts: [
      'AI infrastructure quietly expanded as companies like Google, Meta, and Microsoft built hyperscale data centers.',
      'Each new site required hundreds of megawatts—enough to power tens of thousands of homes.'
    ]
  },
  {
    year: 2022,
    ...
    facts: [
      'ChatGPT launched, sparking global gAI use.',
      'Global data centers consumed ~460 terawatt-hours—roughly equivalent to France’s entire electricity use.',
      'GPT-3 training consumed ~1,287 megawatt-hours (1.3 million kilowatt-hours), enough to power about 120 U.S. homes for a year.'
    ]
  },
  {
    year: 2023,
    ...
    facts: [
      'Training GPT-4 likely required millions of liters of water.',
      'Each user session with ChatGPT (~20 prompts) indirectly consumed ~500ml—roughly a standard water bottle.',
      'U.S. AI data centers began drawing over 4% of national electricity.'
    ]
  },
  {
    year: 2024,
    ...
    facts: [
      'Over 3.8 million high-performance GPUs shipped globally to meet AI demand.',
      'Rapid hardware turnover accelerated e-waste growth.',
      'Cloud providers announced plans to double data-center capacity within two years.'
    ]
  },
  {
    year: 2025,
    ...
    facts: [
      'U.S. projections showed data centers may consume 6.7% to 12% of national electricity by 2028.',
      'That demand rivals or exceeds the total electricity use of some countries.',
      'Utilities in Virginia and Arizona delayed new AI server farms due to power strain.'
    ]
  },
  {
    year: 2026,
    ...
    facts: [
      'The EU passed the AI Act, requiring disclosure of energy, water, and carbon metrics for large models.',
      'Several U.S. states introduced similar transparency bills.',
      'Tech firms began issuing sustainability labels for their AI APIs.',
      'Severe drought in Arizona forced an emergency shutdown of a major AI data center cluster after it was revealed the facility consumed over 50 million gallons of potable water annually. Municipal water restrictions expanded across tech corridors.'
    ]
  },
  {
    year: 2028,
    ...
    facts: [
      'U.S. AI data centers were projected to consume 720 billion gallons of water annually for cooling.',
      'That equals the indoor water use of roughly 18 million homes.',
      'Major drought states, including Arizona, restricted AI expansion permits.',
      'Rolling blackouts hit Northern Virginia during a summer heatwave after AI-driven data centers exceeded regional grid capacity, prompting backlash against unregulated AI infrastructure growth.'
    ]
  },
  {
    year: 2030,
    ...
    facts: [
      'Unregulated gAI growth could emit 220 million metric tons of CO₂ annually.',
      'That footprint is comparable to 50 million gasoline-powered cars.',
      'Companies scrambled to integrate carbon-aware scheduling and dynamic model loading.',
      'Global AI-related emissions surpassed 250 MtCO₂/year—more than the annual footprint of Australia—causing the UN to flag AI as a major threat to climate targets.'
    ]
  },
  {
    year: 2032,
    ...
    facts: [
      'New global rules required modular, upgradeable GPUs for AI hardware.',
      'Chip refresh cycles slowed to 5 years, reducing landfill-bound electronics by 60%.'
    ]
  },
  {
    year: 2033,
    progress: 0.72,
    label: 'E-Waste Crisis',
    fact: 'Discarded AI chips and servers from rapid hardware upgrades piled up in low-income countries, overwhelming waste facilities. Toxic leachate from informal recycling poisoned local water supplies.',
    facts: [
      'Discarded AI chips and servers from rapid hardware upgrades piled up in low-income countries, overwhelming waste facilities.',
      'Toxic leachate from informal recycling poisoned local water supplies, sparking global health concerns.'
    ]
  },
  {
    year: 2035,
    ...
    facts: [
      'AWS, Google, and Azure certified 100% carbon-free operations in the U.S. and EU.',
      'Renewable-aligned inference scheduling became industry standard, shifting workloads to times and places with solar or wind surpluses.'
    ]
  },
  {
    year: 2036,
    progress: 0.79,
    label: 'Compute Inequality',
    fact: 'Global South nations demanded restrictions on Western AI expansion after evidence showed most energy and water use benefited high-income countries while lower-income regions bore resource extraction and waste burdens.',
    facts: [
      'Global South nations demanded restrictions on Western AI expansion after evidence of deep resource inequity.',
      '90% of AI energy and water use benefited high-income countries while lower-income regions bore extraction and waste burdens.'
    ]
  },
  {
    year: 2038,
    progress: 0.82,
    label: 'Peak Demand Plateau',
    fact: 'AI power demand hit a plateau as efficiency mandates arrived; model distillation and hardware reuse slowed new-build growth. Reclaimed-water cooling became the norm in arid regions.',
    facts: [
      'AI power demand hit a plateau as efficiency mandates arrived; model distillation curbed runaway compute.',
      'Hardware reuse and modular upgrades slowed new-build growth, stretching GPU lifecycles.',
      'Reclaimed-water cooling became the norm in arid regions to blunt fresh-water use.'
    ]
  },
  {
    year: 2040,
    ...
    facts: [
      'Advanced immersion cooling and reclaimed wastewater systems slashed water consumption by 70%.',
      'Urban data centers fed district heating networks with AI waste heat, warming homes in winter.',
      'A carbon accounting miscalculation revealed that “carbon-neutral” AI operations were underreporting lifecycle emissions by 40% due to untracked embodied energy in chip manufacturing.'
    ]
  },
  {
    year: 2042,
    progress: 0.9,
    label: 'Resilient Grids',
    fact: 'Long-duration storage and modular nuclear peakers cushioned AI-driven peaks. Per-query emissions fell another 25% versus 2035 as adaptive routing favored surplus renewables.',
    facts: [
      'Long-duration storage and modular nuclear peakers cushioned AI-driven power peaks.',
      'Per-query emissions fell another 25% versus 2035 as adaptive routing favored surplus renewables.',
      'Grid operators prioritized AI workloads during high-renewable intervals to minimize carbon intensity.'
    ]
  },
  {
    year: 2043,
    progress: 0.925,
    label: 'Cooling Crisis',
    fact: 'Global heatwaves broke temperature records; AI data centers across the U.S., India, and Europe were unable to maintain cooling systems. Emergency AI throttling was enforced to preserve grid integrity and freshwater reserves.',
    facts: [
      'Global heatwaves broke temperature records; AI data centers across the U.S., India, and Europe failed to maintain cooling systems.',
      'Emergency AI throttling was enforced to preserve grid integrity and freshwater reserves.'
    ]
  },
  {
    year: 2045,
    ...
    facts: [
      'Global recycling infrastructure enabled recovery of 80% of rare earth metals from old AI chips.',
      'Manufacturing emissions dropped through reuse-first chip design.'
    ]
  },
  {
    year: 2047,
    progress: 0.97,
    label: 'Digital Black Box',
    fact: 'Generative AI became essential to climate modeling and disaster forecasting, but its emissions footprint grew so large it paradoxically accelerated the ecological risks it was meant to mitigate.',
    facts: [
      'Generative AI became essential to climate modeling, disaster forecasting, and infrastructure planning.',
      'Its emissions footprint was so high it created a paradox: the tools predicting ecological collapse were accelerating it.'
    ]
  },
  {
    year: 2050,
    ...
    facts: [
      'With carbon-free energy and optimized workloads, each AI query uses 90% less energy than in 2023.',
      'Generative AI becomes a model of sustainable computing through policy, innovation, and infrastructure alignment.',
      'A global audit found unchecked AI infrastructure growth added over 2.5 gigatons of CO₂ between 2022 and 2050, triggering calls for a moratorium on new training runs.'
    ]
  }
];
...
function getFactsForYear(year) {
  const entry = findTimelineEntry(year);
  if (!entry) return [];
  if (Array.isArray(entry.facts) && entry.facts.length) return entry.facts;
  if (entry.fact) return [entry.fact];
  return [];
}

// Expose a small debug handle in the browser for quick checks
if (typeof window !== 'undefined') {
  window.gaiDebug = {
    version: '2020-defaults+easing',
    get progress() {
      return progress;
    },
    get currentYear() {
  ...
  // convenience globals for ad-hoc console checks
  window.getProgressForYear = getProgressForYear;
}
...
function applyProgressSideEffects() {
  ...
  updateScaleFlares(clock ? clock.elapsedTime : 0, 0);
  updateScaleTooltips();
...
function updateBackgroundForProgress() {
  // Darken and muddy the backdrop as progress increases, but fully reset when progress drops
  const eased = Math.pow(clamp01(progress), 1.35);
  const top = lerpHexColor('#3aa7ff', '#2c3a34', eased);
  const mid = lerpHexColor('#19507d', '#0f171d', eased);
  const deep = lerpHexColor('#163a6b', '#05070c', eased);
  const gradient = `radial-gradient(circle at 40% 25%, ${top}, ${mid} 68%, ${deep} 100%)`;
  document.body.style.setProperty('background', gradient, 'important');

  const bgLayer = document.getElementById('bg');
  if (bgLayer) {
    const bgOpacity = 0.8 - 0.25 * eased;
    bgLayer.style.opacity = `${Math.max(0.25, bgOpacity)}`;
    bgLayer.style.filter = `saturate(${1 - 0.45 * eased}) brightness(${1 - 0.18 * eased}) sepia(${0.15 * eased})`;
  }

  const surface = document.getElementById('surface');
  if (surface) {
    surface.style.opacity = `${Math.max(0, 0.32 - 0.18 * eased)}`;
    surface.style.filter = `blur(${2.5 * eased}px) saturate(${1 - 0.4 * eased})`;
  }

  const caustics = document.getElementById('caustics');
  if (caustics) {
    caustics.style.opacity = `${Math.max(0, 0.35 - 0.2 * eased)}`;
  }

  const sun = document.getElementById('sun');
  if (sun) {
    sun.style.opacity = `${Math.max(0, 0.08 - 0.05 * eased)}`;
  }
}
...
function setupTimelineSlider() {
  ...
  lastSliderYear = currentYear;
  lastSliderUpdateTime = clock ? clock.getElapsedTime() : 0;

  // Update on slider change
  slider.addEventListener('input', (e) => {
    const newYear = parseInt(e.target.value);
    const now = clock ? clock.getElapsedTime() : performance.now() * 0.001;
    const yearDelta = Math.abs(newYear - lastSliderYear);
    const timeDelta = Math.max(0.001, now - lastSliderUpdateTime);
    timelineScrubBoost = Math.min(3, timelineScrubBoost + (yearDelta / timeDelta) * 0.08);
    lastSliderYear = newYear;
...
function initScaleFlares() {
  ...
  SCALE_FLARES.forEach((entry) => {
    const facts = getFactsForYear(entry.year);
    ...
    for (let i = 0; i < SCALE_DUPLICATES; i++) {
      ...
      if (tex) {
        glowMaterial.map = tex;
        glowMaterial.alphaMap = tex;
      }
      ...
      if (scaleTooltipContainer) {
        ...
        const factText = facts.length ? facts[i % facts.length] : '';
      ...
      scaleFlares.push({
        ...
        glow,
        startTime: null,
        loopOffset: seededRandom(entry.seed + i, 8) * 0.25,
        isActive: false,
      });
    }
  });
...
function updateScaleFlares(time, deltaTime = 0) {
  if (!scaleFlares.length) return;

  // Scrub boost decays over time
  if (deltaTime > 0) {
    timelineScrubBoost = Math.max(0, timelineScrubBoost - deltaTime * 1.6);
  } else {
    timelineScrubBoost = Math.max(0, timelineScrubBoost - 0.02);
  }

  scaleFlares.forEach((flare) => {
    const isActiveYear = currentYear === flare.year;

    if (!isActiveYear) {
      flare.isActive = false;
      flare.startTime = null;
      flare.env = 0;
      flare.mesh.position.copy(flare.basePos);
      flare.mesh.scale.set(1, 1, 1);
      flare.mesh.visible = false;
      if (flare.glow) flare.glow.visible = false;
      if (flare.tooltipEl && activeScaleTooltip === flare.tooltipEl) {
        activeScaleTooltip = null;
    ...
    if (!flare.isActive) {
      flare.isActive = true;
      flare.startTime = time;
      flare.mesh.visible = true;
      if (flare.glow) flare.glow.visible = true;
    }

    const speedBoost = 1 + timelineScrubBoost * 0.8;
    const elapsed = (time - (flare.startTime || time)) * speedBoost + flare.loopOffset;
    const cycleDuration = 5.5; // slower baseline drift
    const cycleT = ((elapsed % cycleDuration) / cycleDuration);

    // Flow outward and gently wobble
    const travel = 0.05 + cycleT * 0.75; // reduced travel so scales drift away more gently
    const wobbleAmount = 0.025 + 0.06 * Math.sin(time * 2 + flare.seed);
    const wobbleVec = new THREE.Vector3(
      Math.sin(time * 1.4 + flare.seed) * wobbleAmount,
      Math.cos(time * 1.8 + flare.seed) * wobbleAmount,
      Math.sin(time * 1.1 + flare.seed) * wobbleAmount * 0.6
    );
    const drift = flare.dir.clone().multiplyScalar(travel);
    flare.mesh.position.copy(flare.basePos).add(drift).add(wobbleVec);

    const size = 1.35 + cycleT * 1.05; // larger for visibility
    const aspect = 0.9 + seededRandom(flare.seed, 7) * 0.3;
    flare.mesh.scale.set(size, size * aspect, 1);

    const mat = flare.mesh.material;
    const fade = 1 - Math.pow(cycleT, 1.4);
    flare.env = fade;
    mat.opacity = 0.6 + 0.8 * fade; // brighter overall
    if (flare.glow && flare.glow.material) {
      flare.glow.material.opacity = 0.45 + 0.8 * fade; // stronger outline glow
    }
...
function updateScaleTooltips() {
  ...
  scaleFlares.forEach((flare) => {
    ...
    const isActive = activeScaleTooltip === tooltip && flare.year === currentYear && flare.mesh.visible;
    if (!isActive) {
...
function findFlareFromObject(object) {
  let current = object;
  while (current) {
    const flare = scaleFlares.find((f) => f.mesh === current);
    if (flare) {
      return flare;
    }
    current = current.parent;
...
function onMouseClick(event) {
  ...
  if (scaleFlares.length && renderer && camera) {
    ...
    if (hits.length > 0) {
      const flare = findFlareFromObject(hits[0].object);
      if (flare && flare.tooltipEl && flare.mesh.visible) {
